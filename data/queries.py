...
def operational_old_show_history(id):
    ...
    P.VALOR_LIQUIDO AS 'VALOR LÍQUIDO',
    P.VALOR_ARTISTA_A_RECEBER AS 'VALOR A RECEBER ARTISTA',
    P.VALOR_ESHOWS_RECEBIMENTO AS 'VALOR RECEBIDO ESHOWS',
...
def operational_explore_stages(id):
    ...
    CI.CREATED_AT AS 'DATA DE CRIAÇÃO',
    CASE
    ...
    CI.LAST_UPDATE AS 'ÚLTIMA ATUALIZAÇÃO'
